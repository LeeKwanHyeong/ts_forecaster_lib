...
def test_patchmixer_quantile_characterization_baseline() -> None:
    ...
    expected = torch.tensor(
        [
            [
                [-0.91688573, -1.30564559, -1.50835443, -1.27055120],
                [0.19710144, -0.19652125, -0.40313846, -0.16084625],
                [1.30621600, 0.91746122, 0.71203101, 0.95283556],
            ],
            [
                [0.97423226, 0.63807631, 0.48311931, 0.72771358],
                [2.06385159, 1.73772430, 1.58657336, 1.82492387],
                [3.10458040, 2.79568052, 2.65176773, 2.87848902],
            ],
        ]
    )
